...
const fomr= document.querySelector('.lorem-form');
const amount = document.getElementById('amount');
const result = document.querySelector('.lorem-text');

fomr.addEventListener('submit', function(e){
  e.preventDefault();//we need to prevent default due to the event submit usually is for a server, so if you use console.log('hello') it will appear for a short period of time then disapear, so we use preventDefault to no let that happen
  //console.log('hello');
